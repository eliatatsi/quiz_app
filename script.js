  ...
  '11-16': [
    {
      ...
      correct: 3
        ...
        "question": "Ποιο είναι σώμα του ήλιακού μας συστήματος;",
    ...
    },
    {
        ...
        "answers": ['Φιλελεύθερη δημοκρατία', 'Προεδρική δημοκρατία', 'Μοναρχία', 'Προεδρευόμενη κοινοβουλευτική δημοκρατία'],
        "correct": 3
    }
  ],
  '16+': [
    {
    ...
    }  
      {
        ...
        "answers": ['Βραζιλιάνικα', 'Πορτογαλικα', 'Ισπανικά', 'Μεξικάνικα'],
        "correct": 1
    },
    {
        "question": "Ποια Ήπειρος είναι η μεγαλύτερη σε έκταση;",
    ...
    {
        "question": "Ποιο είναι το μεγαλύτερο όργανο του ανθρώπινου σώματος",
        "answers": ['Πνεύμονες', 'Στομάχι', 'Έντερο', 'Δέρμα'],
        "correct": 3
    }
  ]
};
